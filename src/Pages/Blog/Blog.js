...
const Blog = () => {
    return (
        <div className='container'>
            <h1>Blogs</h1>
            <div style={{ textAlign: 'left' }} className='row gx-5 py-5'>
                <div className='col-md-4'>
                    <div>
                        <h5>Q1: Difference between `authorization` and `authentication`</h5>
                        <p>Authentication is a procces that verify who is someone with valid email and password or any social media login. On the other hand, Authorization id a process of verifying that user have access to something. Authentication done before authorization. Authentication check user valid email an password, Authorization check user security system.</p>
                    </div>
                </div>
                <div className='col-md-4'>
                    <div>
